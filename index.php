...
if (isset($_GET['newsletter'])) {
    if ($_GET['newsletter'] == 'success') {
        $newsletterMessage = 'Dziękujemy za zapis do newslettera!';
    } elseif ($_GET['newsletter'] == 'error') {
        $newsletterMessage = 'Nieprawidłowy adres e-mail.';
    }
}
?>
  ...
  <section class="hero">
    <div class="container hero-content">
      <div class="hero-text">
        ...
        <a href="kontakt.php" class="btn primary">Umów wizytę</a>
      </div>
      <div class="hero-image">
        <img src="image/przychodnia.webp" alt="MediClinic - wnętrze kliniki" />
      </div>
    </div>
  </section>
...
<section class="newsletter">
  ...
  <p style="color: green;"><?php echo $newsletterMessage; ?></p>
<?php endif; ?>
    <form action="zapisz_newsletter.php" method="POST">
